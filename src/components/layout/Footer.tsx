            ...
            <div className="footer__brand">
              ...
              <div className="footer__social">
                ...
                <a href={siteConfig.social.tripadvisor} target="_blank" rel="noopener noreferrer" aria-label="TripAdvisor">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 2a8 8 0 110 16 8 8 0 010-16zm-1 4a3 3 0 100 6 3 3 0 000-6zm2 0a3 3 0 100 6 3 3 0 000-6z"/></svg>
                </a>
              </div>
            </div>
